...
def obtener_episodios_tvdb(url, roeper = False):
...
def create_data(url_snippet="siskel-and-ebert-at-the-movies", roeper=False, output_path="data/videos_web.txt"):
    # Obtener los títulos de los episodios de TVDB
    url = f"https://thetvdb.com/series/{url_snippet}/allseasons/official"
    videos_web = obtener_episodios_tvdb(url, roeper)
